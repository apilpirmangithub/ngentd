...
export default function StoryAnimation({
  ...
  docEl.className = mode === "tee"
    ...
    : "pointer-events-none rounded-md bg-gray-200/90 px-2.5 py-1.5 text-gray-900 shadow transform-gpu";
    ...
    <div className="w-full max-w-[80rem]">
      ...
      >
        ...
        >
          ...
          <div className="mt-1 text-center text-xs font-bold opacity-80">IP Buyer</div>
        </div>
